...
//    if (Offset == 0 && !Config->Game.Files) return false;
...
const double CTexturePool::GetTextureCoords(int MirrorX, int MirrorY, int Rotation, int Corner, int UV)
{
    return TextureCoords[MirrorX][MirrorY][Rotation][Corner][UV];
}
